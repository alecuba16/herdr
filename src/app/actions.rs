...
mod tests {
    ...
    #[test]
    fn close_parent_worktree_workspace_keeps_linked_children() {
    ...
    #[test]
    fn close_pane_last_pane_in_parent_worktree_group_closes_parent_only() {
    ...
    #[test]
    fn close_tab_last_tab_in_parent_worktree_group_closes_parent_only() {
        let mut state = app_with_workspaces(&["parent", "child"]);
        mark_parent_worktree(&mut state, 0);
        mark_linked_worktree(&mut state, 1);
        state.active = Some(0);
    ...
    #[test]
    fn close_pane_last_pane_in_parent_worktree_group_keeps_children_when_confirmation_disabled() {
